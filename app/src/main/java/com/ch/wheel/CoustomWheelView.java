...
public class CoustomWheelView extends View implements View.OnTouchListener {
    ...
    public CoustomWheelView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public CoustomWheelView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public CoustomWheelView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(distance) > radiusBorder) {
