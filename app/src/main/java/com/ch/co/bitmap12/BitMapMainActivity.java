...
public class BitMapMainActivity extends Activity implements OnScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        initView();
        mImageLoader = ImageLoader.build(BitMapMainActivity.this);
    }
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.bitmap_image_list_item,parent, false);
