...
public class ViewRemoteDemoActivity_2 extends Activity {
    ...
    public void onButtonClick(View v) {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(this,
                0, new Intent(this, ViewRemoteDemoActivity_1.class), PendingIntent.FLAG_UPDATE_CURRENT);
        PendingIntent openActivity2PendingIntent = PendingIntent.getActivity(
                this, 0, new Intent(this, ViewRemoteDemoActivity_2.class), PendingIntent.FLAG_UPDATE_CURRENT);
